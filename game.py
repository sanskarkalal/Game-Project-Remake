...
class Display:
  ...
  def end(self):
    ...
    self.type.write(f"YOU LOSE XD  \n",
                    align='center',
                    font=("Times New Roman", "20", "normal"))
    self.type.goto((0, 145))
    self.type.write(f"HIGH SCORE:{self.level} ",
                    align='center',
                    font=("Times New Roman", "20", "normal"))
  ...
  def update(self):
    ...
    # noinspection PyTypeChecker
    self.type.write(f'Lives:{self.lives} Level: {self.level} ',
                    align='center',
...
display = Display()
player = Character([-175, 0], [-175, 0], [0, 0], 15, "kanye.gif")
harm1 = Character([-125, 0], [-125, 0], [0, -.2], 25, "pete.gif")
harm2 = Character([-75, 0], [-75, 0], [0, .15], 25, "pete.gif")
harm3 = Character([-25, 0], [-25, 0], [0, .2], 25, "pete.gif")
harm4 = Character([25, 0], [25, 0], [0, .075], 25, "pete.gif")
harm5 = Character([75, 0], [75, 0], [0, -.13], 25, "pete.gif")
harm6 = Character([125, 0], [125, 0], [0, .1], 25, "pete.gif")
door = Character([175, 100], [175, 100], [0, 0], 25, "kim.gif")
